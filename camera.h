...
namespace m1
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::mat4 rot_mat = glm::rotate(glm::mat4(1), angle, right);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            glm::mat4 rot_mat = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0));
            forward = glm::vec3(glm::normalize(rot_mat * glm::vec4(forward, 1)));
            right = glm::vec3(glm::normalize(rot_mat * glm::vec4(right, 1)));
            up = glm::normalize(glm::cross(right, forward));
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 rot_mat = glm::rotate(glm::mat4(1), angle, forward);
            right = glm::vec3(glm::normalize(rot_mat * glm::vec4(right, 1)));
            up = glm::normalize(glm::cross(right, forward));
        }
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            glm::mat4 mat = glm::translate(glm::mat4(1), -forward * distanceToTarget);
            mat = glm::rotate(glm::mat4(1), angle, right);
            forward = glm::vec3(glm::normalize(mat * glm::vec4(forward, 1)));
            mat = glm::translate(glm::mat4(1), forward * distanceToTarget);
        ...
        void RotateThirdPerson_OY(float angle)
        {
            ...
            glm::mat4 mat = glm::translate(glm::mat4(1), forward * distanceToTarget);
            forward = glm::vec3(glm::normalize(mat * glm::vec4(forward, 1)));
            mat = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0));
            forward = glm::vec3(glm::normalize(mat * glm::vec4(forward, 1)));
            right = glm::vec3(glm::normalize(mat * glm::vec4(right, 1)));
            mat = glm::translate(glm::mat4(1), -forward * distanceToTarget);
            forward = glm::vec3(glm::normalize(mat * glm::vec4(forward, 1)));
